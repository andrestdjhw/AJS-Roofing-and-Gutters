<?php
/**
 * Template Name: Location - Far NE Heights (87111)
 */
  ...
  <section class="bg-[#f5f7f8] py-16 md:py-20">
    <div class="mx-auto max-w-5xl px-4">
      ...
      <h2 class="ajs-reveal text-3xl font-black tracking-[-0.03em] text-[#132d41]">
        Established Neighborhoods. Long-Term Homeowners.
      </h2>

      <div class="mt-10 grid gap-6 md:grid-cols-3">

        <div class="ajs-stat-card ajs-reveal">
          <span class="ajs-stat-number">$380K–$620K</span>
          <span class="ajs-stat-label">Typical home value in 87111</span>
        </div>

        <div class="ajs-stat-card ajs-reveal">
          <span class="ajs-stat-number">20–40 yrs</span>
          <span class="ajs-stat-label">Stable, long-term homeowners</span>
        </div>

        <div class="ajs-stat-card ajs-reveal">
          <span class="ajs-stat-number">Trust-Based</span>
          <span class="ajs-stat-label">High trust-based buying market</span>
        </div>
  ...
  <section class="py-16 md:py-20">
    <div class="mx-auto max-w-7xl px-4">
      ...
      <h2 class="ajs-reveal text-3xl font-black tracking-[-0.03em] text-[#132d41] text-center">
        Roofing &amp; Gutter Services in Far NE Heights
      </h2>
...
<section class="bg-[#f5f7f8] py-16 md:py-20">
      ...
      <div class="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        ...
        <div class="ajs-reveal">
          ...
          <h2 class="text-3xl md:text-4xl font-black tracking-[-0.03em] text-[#132d41]">
            Far NE Heights · 87111
          </h2>

          <p class="mt-6 text-[#42474b] text-lg leading-8">
            AJS Roofing &amp; Gutters serves homeowners across Far NE Heights and the 87111 area with clear communication, documented processes, and reliable execution from start to finish.
          </p>
          ...
          <div class="mt-6 rounded-[18px] border border-[#d3d8db] bg-[#f5f7f8] p-5">
            ...
            <p class="mt-2 text-base font-bold text-[#132d41]">
              Far NE Heights · Albuquerque, NM · 87111
            </p>
          </div>
        </div>
        ...
        <div class="ajs-reveal">
          <div class="overflow-hidden rounded-[22px] border border-[#d3d8db] shadow-[0_14px_32px_rgba(19,45,65,0.08)]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12269.341827460903!2d-106.56454054989968!3d35.137630801264436!2m3!1f0!2f0!3f0!2m3!1i1024!2i768!4f13.1!3m3!1m2!1s0x872275685b9521ff%3A0x8db39e769c492c0a!2sHeights Rd NE%2C Albuquerque%2C NM 87111%2C USA!5e1!3m2!1sen!2shn!4v1774275976158!5m2!1sen!2shn"
              width="100%"
              height="340"
              style="border:0;"
              allowfullscreen=""
  ...
  <section class="py-16 md:py-20">
    <div class="mx-auto max-w-4xl px-4">
      ...
      <h2 class="ajs-reveal text-3xl font-black text-[#132d41] text-center">
        Roofing Questions from Far NE Heights Homeowners
      </h2>
      ...
      <form id="ajsLocationForm" class="ajs-reveal ajs-form-wrap">
        ...
        <div class="grid gap-4 md:grid-cols-2">
          ...
          <div class="ajs-field md:col-span-2">
            ...
            <input id="ajs_location_address" name="address" type="text" placeholder="87111" required>
          </div>
          <div class="ajs-field md:col-span-2">
