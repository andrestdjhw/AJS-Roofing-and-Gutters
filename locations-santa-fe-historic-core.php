<?php
/**
 * Template Name: Location - Santa Fe Historic Core (87501)
 */
  ...
  <section class="relative overflow-hidden bg-[linear-gradient(135deg,#132d41_0%,#1c425f_100%)] text-white py-20">
    <div class="mx-auto max-w-5xl px-4 text-center">
      ...
      <p class="ajs-reveal text-xs font-black uppercase tracking-[0.18em] text-[#6eaace]">
        Santa Fe Historic Core · ZIP 87501
      </p>
  ...
  <section class="bg-[#f5f7f8] py-16 md:py-20">
    <div class="mx-auto max-w-5xl px-4">
      ...
      <h2 class="ajs-reveal text-3xl font-black tracking-[-0.03em] text-[#132d41]">
        Complex Roofs. Premium Expectations.
      </h2>

      <div class="mt-10 grid gap-6 md:grid-cols-3">

        <div class="ajs-stat-card ajs-reveal">
          <span class="ajs-stat-number">$600K–$1.1M+</span>
          <span class="ajs-stat-label">Typical home value in 87501</span>
        </div>

        <div class="ajs-stat-card ajs-reveal">
          <span class="ajs-stat-number">Complex</span>
          <span class="ajs-stat-label">Roof architecture in this area</span>
        </div>

        <div class="ajs-stat-card ajs-reveal">
          <span class="ajs-stat-number">Premium</span>
          <span class="ajs-stat-label">Market expectations</span>
        </div>
  ...
  <section class="py-16 md:py-20">
    <div class="mx-auto max-w-7xl px-4">
      ...
      <h2 class="ajs-reveal text-3xl font-black tracking-[-0.03em] text-[#132d41] text-center">
        Roofing &amp; Gutter Services in Santa Fe Historic Core
      </h2>
...
<section class="bg-[#f5f7f8] py-16 md:py-20">
  <div class="mx-auto max-w-7xl px-4">
    ...
    <h2 class="ajs-reveal text-3xl font-black text-[#132d41] text-center">
      Projects in Santa Fe Historic Core
    </h2>
  ...
  <section class="py-16 md:py-20">
    <div class="mx-auto max-w-4xl px-4">
      ...
      <h2 class="ajs-reveal text-3xl font-black text-[#132d41] text-center">
        Roofing Questions from Santa Fe Historic Core Homeowners
      </h2>
      ...
      <div class="mt-10 space-y-4" itemscope itemtype="https://schema.org/FAQPage">
        ...
        <details class="ajs-faq ajs-reveal" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary itemprop="name">How do you protect the property during a roofing project?</summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Our crew arrives on schedule. Materials are staged, safety protocols followed, and your property is protected throughout. We treat your home like it's ours. Every project ends with a final walkthrough with you present, complete cleanup, and a warranty packet with before/after documentation and material specs.</p>
          </div>
        </details>
      ...
      <form id="ajsLocationForm" class="ajs-reveal ajs-form-wrap">
        ...
        <div class="grid gap-4 md:grid-cols-2">
          ...
          <div class="ajs-field md:col-span-2">
            ...
            <input id="ajs_location_address" name="address" type="text" placeholder="87501" required>
          </div>
          <div class="ajs-field md:col-span-2">
