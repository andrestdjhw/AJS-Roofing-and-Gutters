<?php
/**
 * Template Name: Location - Albuquerque West (87120)
 */
    ...
    <div class="mx-auto max-w-5xl px-4">
      ...
      <div class="mt-10 grid gap-6 md:grid-cols-3">
        ...
        <div class="ajs-stat-card ajs-reveal">
          ...
          <span class="ajs-stat-label">Active roofing market in 87120</span>
        </div>

        <div class="ajs-stat-card ajs-reveal">
          <span class="ajs-stat-number">Shingle</span>
          <span class="ajs-stat-label">Primary replacement market</span>
        </div>
    ...
    <div class="mx-auto max-w-7xl px-4">
      ...
      <div class="mt-10 grid gap-5 md:grid-cols-3">
        ...
        <div class="ajs-img-card ajs-reveal">
          <img src="/wp-content/uploads/roof1.jpg" alt="Roofing project Albuquerque West 87120">
        </div>

        <div class="ajs-img-card ajs-reveal">
          <img src="/wp-content/uploads/roof2.jpg" alt="Shingle roof replacement Albuquerque West">
        </div>

        <div class="ajs-img-card ajs-reveal">
          <img src="/wp-content/uploads/roof3.jpg" alt="Seamless gutters 87120 Albuquerque West">
        </div>
