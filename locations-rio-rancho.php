<?php
/**
 * Template Name: Location - Rio Rancho (87124)
 */
...
<main class="bg-white text-[#42474b] overflow-hidden">
  ...
  <section class="py-16 md:py-20">
    <div class="mx-auto max-w-4xl px-4">
      ...
      <h2 class="ajs-reveal text-3xl md:text-4xl font-black tracking-[-0.03em] text-[#132d41]">
        Where Chaos Ends. Home Begins.
      </h2>

      <p class="ajs-reveal mt-6 text-[#42474b] text-lg leading-8">
        AJS Roofing &amp; Gutters is a licensed roofing contractor serving Rio Rancho — one of New Mexico's most active and competitive roofing markets. When there's no shortage of contractors to choose from, the difference comes down to process, documentation, and work done right from the start. AJS brings order to a decision that usually feels chaotic, with clear communication at every step and a documented system built to protect your home — not just close a sale.
      </p>
...
<section class="bg-[#f5f7f8] py-16 md:py-20">
  <div class="mx-auto max-w-5xl px-4 text-center">
    ...
    <p class="ajs-reveal text-xs font-black uppercase tracking-[0.18em] text-[#d04418] mb-3">
      The 87124 Market
    </p>
  ...
  <section class="py-16 md:py-20">
    <div class="mx-auto max-w-7xl px-4">
      ...
      <h2 class="ajs-reveal text-3xl font-black tracking-[-0.03em] text-[#132d41] text-center">
        Roofing &amp; Gutter Services in Rio Rancho
      </h2>

      <div class="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">

        <a href="/service/roof-replacement" class="ajs-location-card ajs-reveal">
          <span class="ajs-card-title">Roof Replacement</span>
        ...
        <a href="/service/gutters" class="ajs-location-card ajs-reveal">
          ...
          <span class="ajs-card-desc">Custom-fabricated on-site with our own machine. No seams, no leaks, no subcontractors. Precision drainage that protects your foundation.</span>
        </a>
        ...
        <a href="/service/storm-damage-insurance" class="ajs-location-card ajs-reveal">
          <span class="ajs-card-title">Storm Damage &amp; Insurance</span>
          <span class="ajs-card-desc">We inspect, document everything with photos, and work with your insurance to streamline the process.</span>
        </a>

        <a href="/service/roof-inspection" class="ajs-location-card ajs-reveal">
          <span class="ajs-card-title">Roof Inspection &amp; Maintenance</span>
          <span class="ajs-card-desc">Photo-documented inspections and annual maintenance plans. Catch small problems before they become expensive ones.</span>
        </a>
...
<section class="bg-[#f5f7f8] py-16 md:py-20">
    ...
    <div class="mx-auto max-w-7xl px-4">
      <div class="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        ...
        <div class="ajs-reveal">
          <p class="text-xs font-black uppercase tracking-[0.18em] text-[#d04418] mb-3">
            Location
          </p>

          <h2 class="text-3xl md:text-4xl font-black tracking-[-0.03em] text-[#132d41]">
            Rio Rancho · 87124
          </h2>

          <p class="mt-6 text-[#42474b] text-lg leading-8">
            AJS Roofing &amp; Gutters serves homeowners across Rio Rancho and the 87124 area with clear communication, documented processes, and reliable execution from start to finish.
          </p>
          ...
          <div class="mt-6 rounded-[18px] border border-[#d3d8db] bg-[#f5f7f8] p-5">
            ...
            <p class="mt-2 text-base font-bold text-[#132d41]">
              Rio Rancho · Albuquerque, NM · 87124
            </p>
          </div>
        </div>
        ...
        <div class="ajs-reveal">
          <div class="overflow-hidden rounded-[22px] border border-[#d3d8db] shadow-[0_14px_32px_rgba(19,45,65,0.08)]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d195700.6259982922!2d-106.92567443661169!3d35.38933458791393!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x87226f933600c25b%3A0x356f6cee92f248f!2sAlbuquerque%2C NM 87124%2C USA!5e1!3m2!1sen!2shn!4v1774276368765!5m2!1sen!2shn"
              width="100%"
              height="340"
              style="border:0;"
              allowfullscreen=""
  ...
  <section class="py-16 md:py-20">
    <div class="mx-auto max-w-4xl px-4">
      ...
      <h2 class="ajs-reveal text-3xl font-black text-[#132d41] text-center">
        Roofing Questions from Rio Rancho Homeowners
      </h2>
      ...
      <div class="mt-10 space-y-4" itemscope itemtype="https://schema.org/FAQPage">
        ...
        <details class="ajs-faq ajs-reveal" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary itemprop="name">There are a lot of roofing contractors in Rio Rancho. How do I choose?</summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">In a competitive market, the right question isn't who's cheapest — it's who can show you their work. Ask any contractor for their process documentation, photo reports, and warranty paperwork. AJS provides a detailed photo inspection before any work begins, photographs every phase of the project, and hands you a complete warranty packet at the end. If a contractor can't show you what they did and how they did it, that's your answer.</p>
          </div>
        </details>

        <details class="ajs-faq ajs-reveal" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary itemprop="name">Do I need a repair or a full replacement?</summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">That depends on what we actually find — and we'll show you with photos. AJS starts every job with an honest, documented inspection. If a repair is the right call, we'll tell you. If replacement makes more financial sense given your roof's age and condition, we'll explain why with data, not pressure. You don't need to understand roofing. That's our job.</p>
          </div>
        </details>
        ...
        <details class="ajs-faq ajs-reveal" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary itemprop="name">What certifications does AJS have?</summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">AJS is a licensed New Mexico roofing contractor, fully insured, and manufacturer-certified. Those certifications matter because they unlock extended warranty coverage that standard contractors simply can't offer. When you work with AJS, your warranty packet includes before and after photos, material specs, and full coverage documentation — not just a handshake promise.</p>
          </div>
        </details>

        <details class="ajs-faq ajs-reveal" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary itemprop="name">Do you serve the entire 87124 ZIP code?</summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Yes. AJS Roofing &amp; Gutters serves homeowners across Rio Rancho and surrounding New Mexico communities. Our recommendations are built for what New Mexico's climate actually does to a roof — not a national average.</p>
          </div>
        </details>
  ...
  <!-- CTA WITH FORM -->
  <section class="bg-[linear-gradient(135deg,#132d41_0%,#1c425f_100%)] text-white py-20">
      ...
      <form id="ajsLocationForm" class="ajs-reveal ajs-form-wrap">
        ...
        <div class="grid gap-4 md:grid-cols-2">
          ...
          <div class="ajs-field md:col-span-2">
            ...
            <input id="ajs_location_address" name="address" type="text" placeholder="87124" required>
          </div>
          <div class="ajs-field md:col-span-2">
        ...
        <div class="mt-4 flex items-start gap-3">
          ...
          <label for="ajs_location_consent" class="text-white/70 text-sm">I agree to be contacted by AJS Roofing &amp; Gutters regarding my request.</label>
        </div>
...
.ajs-field input::placeholder,
.ajs-field textarea::placeholder {
