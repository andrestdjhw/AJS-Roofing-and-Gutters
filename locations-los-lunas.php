<?php
/**
 * Template Name: Location - Los Lunas
 */
  ...
  <section class="relative overflow-hidden bg-[linear-gradient(135deg,#132d41_0%,#1c425f_100%)] py-20 text-white">
    <div class="mx-auto max-w-5xl px-4 text-center">
      ...
      <h1 class="ajs-reveal mt-4 text-4xl font-black leading-tight tracking-[-0.04em] md:text-5xl lg:text-6xl">
        Roofing Company in Los Lunas · AJS Roofing &amp; Gutters
      </h1>
  ...
  <section class="py-16 md:py-20">
    <div class="mx-auto max-w-4xl px-4">
      ...
      <p class="ajs-reveal mt-6 text-lg leading-8 text-[#42474b]">
        AJS Roofing &amp; Gutters is a licensed roofing contractor serving Los Lunas and the surrounding area, helping homeowners move from uncertainty to clarity with a process built on communication, craftsmanship, and protection that lasts. We don't just install roofs, we restore peace of mind. Through clear recommendations, professional execution, and work done right from the start, we help homeowners feel confident in every step of the project.
      </p>

      <p class="ajs-reveal mt-5 text-lg leading-8 text-[#42474b]">
        With manufacturer certifications and our own on-site gutter fabrication machine, AJS is the roofing partner that brings order to a process that usually feels chaotic with recommendations built for what New Mexico's UV, hail, wind, and monsoon conditions actually do to a roof.
      </p>
  ...
  <section class="bg-[#f5f7f8] py-16 md:py-20">
    <div class="mx-auto max-w-5xl px-4 text-center">
      ...
      <p class="ajs-reveal mb-3 text-xs font-black uppercase tracking-[0.18em] text-[#d04418]">
        The Los Lunas Market
      </p>

      <h2 class="ajs-reveal text-3xl font-black tracking-[-0.03em] text-[#132d41]">
        Roofing Demand in Los Lunas Requires Clear, Reliable Solutions.
      </h2>
      ...
      <div class="mt-10 flex justify-center">
        <div class="grid w-full max-w-2xl gap-6 md:grid-cols-2">
          ...
          <div class="ajs-stat-card ajs-reveal text-center">
            <span class="ajs-stat-number block">Placeholder</span>
            <span class="ajs-stat-label block mt-2">
              Add local market insight here
            </span>
          </div>
          ...
          <div class="ajs-stat-card ajs-reveal text-center">
            <span class="ajs-stat-number block">Placeholder</span>
            <span class="ajs-stat-label block mt-2">
              Add dominant roof type or demand trend
            </span>
          </div>
  ...
  <section class="py-16 md:py-20">
    <div class="mx-auto max-w-7xl px-4">
      ...
      <h2 class="ajs-reveal text-center text-3xl font-black tracking-[-0.03em] text-[#132d41]">
        Roofing &amp; Gutter Services in Los Lunas
      </h2>
      ...
      <div class="mt-10 grid gap-5 md:grid-cols-3">
        ...
        <div class="ajs-img-card ajs-reveal">
          <img 
            ...
            alt="Roof replacement Los Lunas"
            class="h-full w-full rounded-[20px] object-cover"
          >
        </div>
        ...
        <div class="ajs-img-card ajs-reveal">
          <img 
            ...
            alt="Seamless gutters Los Lunas"
            class="h-full w-full rounded-[20px] object-cover"
          >
        </div>
...
<section class="bg-white py-16 md:py-20">
    ...
    <div class="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
      ...
      <div class="ajs-reveal">
        ...
        <p class="mt-6 text-lg leading-8 text-[#42474b]">
          AJS Roofing &amp; Gutters serves homeowners across Los Lunas and the 87031 area with clear communication, documented processes, and reliable execution from start to finish.
        </p>
      ...
      <div class="ajs-reveal">
        <div class="overflow-hidden rounded-[22px] border border-[#d3d8db] shadow-[0_14px_32px_rgba(19,45,65,0.08)]">
          <iframe
            src="https://www.google.com/maps?q=Los+Lunas,+NM+87031&output=embed"
            width="100%"
            height="340"
            style="border:0;"
            allowfullscreen=""
  ...
  <section class="py-16 md:py-20">
    <div class="mx-auto max-w-4xl px-4">
      ...
      <h2 class="ajs-reveal text-center text-3xl font-black text-[#132d41]">
        Roofing Questions from Los Lunas Homeowners
      </h2>
      ...
      <div class="mt-10 space-y-4" itemscope itemtype="https://schema.org/FAQPage">
        ...
        <details class="ajs-faq ajs-reveal" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          ...
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">That depends on the age of the roof, the extent of the damage, and what we find during the inspection. AJS starts with a photo-documented evaluation so you can clearly see whether a repair is enough or whether replacement makes more long-term sense.</p>
          </div>
        </details>

        <details class="ajs-faq ajs-reveal" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary itemprop="name">How does New Mexico weather affect roofs in Los Lunas?</summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Roofs in Los Lunas deal with intense UV exposure, seasonal wind, storm activity, and monsoon moisture. Over time, that combination can accelerate wear on shingles, flashing, sealants, and drainage systems. Regular inspections help catch problems before they become costly.</p>
          </div>
        </details>

        <details class="ajs-faq ajs-reveal" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary itemprop="name">Do you help with storm damage insurance claims in Los Lunas?</summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Yes. AJS can inspect the roof, document visible damage with photos, and help homeowners move through the insurance process with more clarity and less confusion.</p>
          </div>
        </details>

        <details class="ajs-faq ajs-reveal" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary itemprop="name">What makes AJS different from other roofing contractors in Los Lunas?</summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">AJS follows a documented process, communicates clearly, fabricates seamless gutters on-site, and focuses on solutions built for New Mexico conditions instead of generic national recommendations.</p>
          </div>
        </details>

        <details class="ajs-faq ajs-reveal" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary itemprop="name">Do you serve all of Los Lunas?</summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Yes. AJS Roofing &amp; Gutters serves homeowners throughout Los Lunas and nearby communities with roofing and gutter solutions designed for long-term protection.</p>
          </div>
        </details>
