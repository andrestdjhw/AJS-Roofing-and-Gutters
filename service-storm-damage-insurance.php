<?php
/**
 * Template Name: Storm Damage Template
 */
      ...
      <div class="grid gap-12 lg:grid-cols-[1.18fr_0.82fr] lg:items-center">
        <div class="ajs-reveal-left">
          ...
          <h1 class="font-black tracking-[-0.04em] leading-[1.05] text-4xl md:text-5xl lg:text-[4rem] text-white">
            <span class="ajs-title-line" style="--i:0">Storm Damage Roof Repair</span><br>
            <span class="ajs-title-line" style="--i:1">&amp; Insurance Claims</span><br>
            <span class="ajs-title-line" style="--i:2">in New Mexico</span>
          </h1>

          <p class="ajs-slogan mt-5" aria-label="Here’s What We Found.">
            <span class="ajs-slogan-word" style="--i:0">—</span>
            <span class="ajs-slogan-word" style="--i:1"> Here’s</span>
            <span class="ajs-slogan-word" style="--i:2"> What</span>
            <span class="ajs-slogan-word" style="--i:3"> We</span>
            <span class="ajs-slogan-word" style="--i:4"> Found.</span>
          </p>
          ...
          <p class="mt-4 max-w-2xl text-base leading-8 text-white/78">
            AJS provides emergency inspections, comprehensive documentation, and full insurance claim support. We photograph and measure all damage so your claim is complete, accurate, and processed faster. No guesswork. No uncertainty.
          </p>
            ...
            <div class="grid gap-4">
              <div class="ajs-stagger-item rounded-[24px] border border-white/10 bg-white/10 p-5">
                ...
                <h3 class="mt-2 text-xl font-black text-white">
                  Emergency inspection, documentation, and insurance claim support built to reduce confusion after a storm.
                </h3>
                <p class="mt-3 text-sm leading-7 text-white/75">
                  This service centers on identifying real damage, documenting it clearly, and helping the homeowner move forward with better information.
                </p>
              </div>
              ...
              <div class="ajs-stagger-item overflow-hidden rounded-[24px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] p-0">
                <div class="flex min-h-[220px] items-end bg-[linear-gradient(180deg,rgba(19,45,65,0.1),rgba(19,45,65,0.36)),linear-gradient(180deg,#7998ad_0%,#516f86_100%)] p-5">
                  <span class="text-sm font-black uppercase tracking-[0.16em] text-white/88">
                    Storm damage inspection image area
                  </span>
                </div>
              </div>
            </div>
  ...
  <section class="py-20">
    <div class="mx-auto max-w-5xl px-4 text-center">
      <p class="ajs-reveal inline-block rounded-full bg-[#d04418]/8 px-4 py-2 text-xs font-black uppercase tracking-[0.18em] text-[#d04418]">
        From storm chaos to documented clarity
      </p>
      ...
      <p class="ajs-reveal mt-6 text-lg leading-8 text-[#42474b]">
        When storm damage is real, the next step should start with documentation, not assumptions. Clear photos, measurements, and inspection findings make the situation easier to understand.
      </p>
    </div>
  </section>
    ...
    <div class="mx-auto grid max-w-7xl gap-8 px-4 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
      <div class="ajs-reveal-left">
        ...
        <h2 class="max-w-[14ch] text-3xl font-black tracking-[-0.03em] text-[#132d41] md:text-5xl">
          Local storm damage support with clear communication and reliable execution.
        </h2>
