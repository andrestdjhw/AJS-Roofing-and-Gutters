<?php
/**
 * Template Name: Location - NW ABQ / Rio Rancho (87114)
 */
  ...
  <section class="py-16 md:py-20">
    <div class="mx-auto max-w-7xl px-4">
      ...
      <h2 class="ajs-reveal text-3xl font-black tracking-[-0.03em] text-[#132d41] text-center">
        Roofing &amp; Gutter Services in NW ABQ &amp; Rio Rancho
      </h2>
...
<section class="bg-[#f5f7f8] py-16 md:py-20">
      ...
      <div class="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        ...
        <div class="ajs-reveal">
          ...
          <h2 class="text-3xl md:text-4xl font-black tracking-[-0.03em] text-[#132d41]">
            NW ABQ / Rio Rancho · 87114
          </h2>

          <p class="mt-6 text-[#42474b] text-lg leading-8">
            AJS Roofing &amp; Gutters serves homeowners across NW Albuquerque and Rio Rancho with clear communication, documented processes, and reliable execution from start to finish.
          </p>
          ...
          <div class="mt-6 rounded-[18px] border border-[#d3d8db] bg-[#f5f7f8] p-5">
            ...
            <p class="mt-2 text-base font-bold text-[#132d41]">
              NW ABQ / Rio Rancho · Albuquerque, NM · 87114
            </p>
          </div>
        </div>
        ...
        <div class="ajs-reveal">
          <div class="overflow-hidden rounded-[22px] border border-[#d3d8db] shadow-[0_14px_32px_rgba(19,45,65,0.08)]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d196163.63496559902!2d-106.82546857571208!3d35.198063300864796!2m3!1f0!2f0!3f0!2m3!1i1024!2i768!4f13.1!3m3!1m2!1s0x87227178d7181c17%3A0x6cdc0ed8d488e12a!2sLOS RNCHS ABQ%2C NM 87114%2C USA!5e1!3m2!1sen!2shn!4v1774276321459!5m2!1sen!2shn"
              width="100%"
              height="340"
              style="border:0;"
              allowfullscreen=""
  ...
  <section class="py-16 md:py-20">
    <div class="mx-auto max-w-4xl px-4">
      ...
      <h2 class="ajs-reveal text-3xl font-black text-[#132d41] text-center">
        Roofing Questions from NW ABQ &amp; Rio Rancho Homeowners
      </h2>
      ...
      <form id="ajsLocationForm" class="ajs-reveal ajs-form-wrap">
        ...
        <div class="grid gap-4 md:grid-cols-2">
          ...
          <div class="ajs-field md:col-span-2">
            ...
            <input id="ajs_location_address" name="address" type="text" placeholder="87114" required>
          </div>
          <div class="ajs-field md:col-span-2">
