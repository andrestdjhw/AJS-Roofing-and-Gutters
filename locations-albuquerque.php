    ...
    <div class="mx-auto max-w-7xl px-4">
      ...
      <div class="mt-10 grid gap-5 md:grid-cols-3">
        ...
        <div class="ajs-img-card ajs-reveal">
          <img src="/wp-content/uploads/roof1.jpg" alt="Roofing project Albuquerque NE 87122">
        </div>

        <div class="ajs-img-card ajs-reveal">
          <img src="/wp-content/uploads/roof2.jpg" alt="Metal roofing High Desert Albuquerque">
        </div>

        <div class="ajs-img-card ajs-reveal">
          <img src="/wp-content/uploads/roof3.jpg" alt="Seamless gutters 87122">
        </div>
      ...
      <div class="ajs-reveal ajs-form-wrap">
        ...
        <div class="grid gap-4 md:grid-cols-2">
          ...
          <div class="ajs-field md:col-span-2">
            ...
            <input type="text" placeholder="87122" required>
          </div>
          <div class="ajs-field md:col-span-2">
